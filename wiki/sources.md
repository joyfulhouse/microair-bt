...
| HA passive BLE scan on the nearest indoor proxy | `docs/claude/research/explore-ha-ble-scan.md`, `ble-scan-dump.json` | 2026-09-10, 90 s + 180 s windows over the HA websocket: unit **not heard** on any proxy. Feeds [ha-proxy-coverage](ha-proxy-coverage.md). |
