...
The Android app starts an unfiltered BLE scan (`startScan(callback)`) and its callback accepts a non-null device name containing the selected saved name, falling back to any name containing `EasyStart_` ([Connect.java:471](sources/decompiled/jadx/sources/net/microair/easystart/Connect.java:471), [MainActivityKt.java:342](sources/decompiled/jadx/sources/net/microair/easystart/MainActivityKt.java:342)). The UI recognizes either a 14-character exact ID (`EasyStart_` plus five characters) or the 10-character `EasyStart_` prefix/blank value as "scan for any" ([Connect.java:586](sources/decompiled/jadx/sources/net/microair/easystart/Connect.java:586), [Connect.java:631](sources/decompiled/jadx/sources/net/microair/easystart/Connect.java:631)).

The GATT UUIDs are primary service `d973f2e0-b19e-11e2-9e96-0800200c9a66`, notify characteristic `d973f2e1-b19e-11e2-9e96-0800200c9a66`, and write characteristic `d973f2e2-b19e-11e2-9e96-0800200c9a66` ([MainActivityKt.java:329](sources/decompiled/jadx/sources/net/microair/easystart/MainActivityKt.java:329), [MainActivityKt.java:407](sources/decompiled/jadx/sources/net/microair/easystart/MainActivityKt.java:407)). These are discovered only after connection; the app has no manufacturer-ID check and does not require this service to be present in the advertisement.

## Kaelyn's-bedroom proxy and neighbors

HA's `bluetooth/subscribe_scanner_details` response maps source `70:04:1D:1F:3B:8A` to adapter `aiosense-kaelyns-bedroom`, a connectable remote scanner. This agrees with the ESPHome configuration name, static IP `<proxy-ip>`, and active proxy setting ([aiosense-kaelyns-bedroom.yaml:1](../aiosense/devices/aiosense-kaelyns-bedroom.yaml:1), [aiosense-kaelyns-bedroom.yaml:54](../aiosense/devices/aiosense-kaelyns-bedroom.yaml:54), [aiosense-kaelyns-bedroom.yaml:67](../aiosense/devices/aiosense-kaelyns-bedroom.yaml:67)).
...
Raw/sanitized scan evidence: [ble-scan-dump.json](docs/claude/research/ble-scan-dump.json).
